    ...
    <div class="d-flex custom">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="sidebar-item active"><a class="sidebar-link" href="./posts.html">
                                    ...
                                    <div class="card-title">
                                        ...
                                        <form class="">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea id="blogpost" cols="30" rows="10" class="form-control"
                                                    required></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="currentImg" class="form-label">Current Picture</label>
                                                <!-- <textarea class="form-control" id="subtitle"> </textarea> -->
